...
void setup(){
    ...
    machineStates[0].createButton(new RectButton(950, 332, 30, 30, 2, new RGBColour(255, 255, 255), new RGBColour(255, 255, 255)), 0, 1);
    machineStates[0].createButton(new RectButton(695, 553, 30, 30, 2, new RGBColour(255, 255, 255), new RGBColour(255, 255, 255)), 1, 3);
    //State_1
    machineStates[1] = new States("image_1.jpg", 1, 1);
    machineStates[1].createButton(new RectButton(427, 377, 30, 30, 2, new RGBColour(255, 255, 255), new RGBColour(255, 255, 255)), 0, 0);
    //State_2
    ...
    machineStates[6].createButton(new RectButton(427, 377, 30, 30, 2, new RGBColour(255, 255, 255), new RGBColour(255, 255, 255)), 0, 7);
    //State_7
    machineStates[7] = new States("image_7.jpg", 0, 7);
    //State_8
    machineStates[8] = new States("image_8.jpg", 1, 8);
    machineStates[8].createButton(new RectButton(890, 430, 30, 30, 2, new RGBColour(255, 255, 255), new RGBColour(255, 255, 255)), 0, 9);
    //State_9
